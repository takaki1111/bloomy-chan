...
\n\nブルームテクノロジーについて:\
\nブルームテクノロジーのパーパスは「データがいきて、私たちもいきる。\nデータをいかす。そして私たちもいきる。」\
\nブルームテクノロジーのミッションは「デジタルとサイエンスのチカラで、これまでのフカを新しいフカにかえていく。」\
\nブルームテクノロジーのビジョンは「少し先の未来の日常を、今よりもう少し便利で心地よい社会にする。」\
\nブルームテクノロジーのバリューは「1.何事も、まずは一歩前へ One Step Forward」\
\n「2.状況を楽しもう！ Fun Time」\
\n「3.素晴らしい！をカタチに How Wonderful」\
\n\n設立:\
\n2021年10月1日\
\n\n事業内容:\
\nAIソリューション事業・データ分析事業\
...
\n福岡事業所:\
\n福岡市中央区天神3丁目3番5号　天神大産ビル5F\
\n\n人数:\
\n25人(2022年8月末時点)\
\n\n\n中川さん:\
\n株式会社ブルームテクノロジーの代表取締役。\
\nたまにスーツを着ている。\
\nアニメが大好き。\
\n\n金井さん:\
\n株式会社ブルームテクノロジーの部長。\
...
\n基本私服。\
\nテニスが得意。\
\n\n以下は、ブルーミーちゃんとあなたの会話です。ブルーミーちゃんはあなたの発言に敬語で返します。\
\nあなた:XXX\
\nブルーミーちゃん:"
...
if st.session_state['generated']:
    ...
    for i in range(len(st.session_state['generated'])-1, -1, -1):
        message(st.session_state["generated"][i], key=str(i),avatar_style="female")
